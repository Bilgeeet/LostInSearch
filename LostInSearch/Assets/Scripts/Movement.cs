...
public class Movement
{
    ...
    public void Init(Player player)
    {
        ...
        playerView.position = new Vector3(
            player.TR.position.x,
            player.TR.position.y + playerViewYOffset,
            player.TR.position.z);
    ...
    private void Update()
    {
        ...
        player.TR.rotation = Quaternion.Euler(0, rotY, 0); // Rotates the collider
    ...
    */
    private void AirMove()
    {
        ...
        wishdir = player.TR.TransformDirection(wishdir);
